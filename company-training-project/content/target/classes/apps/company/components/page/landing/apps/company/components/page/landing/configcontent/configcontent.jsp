...
<%
        ...
        for(int i=0;i<tasks.size();i++){
            Task t = tasks.get(i);
            if(optcontentvalueactived.equalsIgnoreCase("all")){
                textotask = textotask+"<input type='checkbox' name='t' checked/>"+t.getTitle()+"<br>";
            }
            else if(optcontentvalueactived.equalsIgnoreCase("active")){
                if(!t.getCompleted()){
                    textotask = textotask+"<input type='checkbox' name='t' checked/>"+t.getTitle()+"<br>";
                }
                else{
            ...
            else if(optcontentvalueactived.equalsIgnoreCase("completed")){
                if(t.getCompleted()){
                    textotask = textotask+"<input type='checkbox' name='t' checked/>"+t.getTitle()+"<br>";
                }
                else{
...
<div>
<form >
  <input type="submit" value="Items Left">
